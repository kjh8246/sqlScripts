...
CREATE TABLE table_date(
	...
	-- 값을 지정안했을 때 기본값(default) : sysdate 는 현재 날짜/시간
);
-- 날짜형식은 문자열 타입과 자동캐스팅 됩니다. ''안에 yyyy-mm-dd hh:mm:ss 문자열 형식으로 작성
...
-- VARCHAR2 타입확인 : CHAR 비교했을때 추가되는 공백 없습니다.
...
INSERT INTO table_string(ccol) VALUES ('가나다라마바사아자차'); -- 10글자 ok
INSERT INTO table_string(ccol) VALUES ('가나다라마바사아자차카'); -- 11글자는 오류

-- NVARCHAR2 타입확인 : 가변길이 , 단위는 문자개수 NCHAR 비교했을때 추가되는 공백 없습니다
...
INSERT INTO table_string(dcol) VALUES ('가나다라마바사아자차'); -- 10글자 ok
INSERT INTO table_string(dcol) VALUES ('가나다라마바사아자차카'); -- 11글자는 오류

-- 여러가지 언어의 문자가 사용되고 저장될때 NVARCHAR2 글자수로 계산하는 것이 권고사항입니다.
